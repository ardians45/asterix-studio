...
export default async function LocalSeoPage({ params }: PageProps) {
  ...
  const localFaqs = [
    ...
    },
    {
      ...
      a: `Biaya pembuatan website bervariasi mulai dari Rp 989.000 untuk paket Starter hingga paket Pro, Max & Custom yang disesuaikan dengan kebutuhan kompleksitas bisnis Anda.`
    },
    {
