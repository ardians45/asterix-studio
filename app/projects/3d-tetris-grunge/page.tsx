...
import { FaArrowLeft, FaExternalLinkAlt, FaCube } from "react-icons/fa";
import { 
  SiReact, 
  SiThreedotjs, 
  SiTailwindcss, 
...
export default function TetrisPage() {
  const techStack = [
    ...
    { name: "R3F", icon: FaCube }, // React Three Fiber
             ...
             <div className="border-t border-white/20 pt-8 flex flex-col md:flex-row justify-between items-end gap-8">
                ...
                <div className="flex flex-col gap-6 md:min-w-[300px] text-right md:text-left">
                     <div>
                        ...
                        <span className="text-xl font-bold">Web Game</span>
                     </div>
                     <div>
                     ...
                     <a 
                        href="https://tetris3dpunk.vercel.app/" 
                        target="_blank" 
                    ...
                    >
                        Play Now <FaExternalLinkAlt className="text-xs" />
                    </a>
                </div>
             </div>
         </div>
      ...
      <div className="container mx-auto px-6 md:px-12 max-w-7xl pt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            ...
            <div className="md:col-span-2 space-y-12">
                <div>
                    <h3 className="text-2xl font-bold mb-6 text-white border-l-4 border-purple-500 pl-4">Overview</h3>
                ...
                <div>
                    <h3 className="text-2xl font-bold mb-6 text-white border-l-4 border-purple-500 pl-4">Key Features</h3>
                ...
                <div>
                    <h3 className="text-2xl font-bold mb-6 text-white border-l-4 border-purple-500 pl-4">Metrics & Achievements</h3>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="bg-[#111] p-6 rounded-2xl border border-white/5">
                            <span className="block text-3xl font-bold text-purple-500 mb-2">60fps</span>
                            <span className="text-gray-400 text-sm">Performance on Mobile</span>
                        </div>
                        <div className="bg-[#111] p-6 rounded-2xl border border-white/5">
                            <span className="block text-3xl font-bold text-purple-500 mb-2">3D</span>
                            <span className="text-gray-400 text-sm">Real-time Rendering</span>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <h3 className="text-2xl font-bold mb-6 text-white border-l-4 border-purple-500 pl-4">Challenges & Solutions</h3>
                    <ul className="space-y-6">
                        <li>
                            <h4 className="text-lg font-bold text-white mb-2">Challenge: 3D Game Logic</h4>
                         ...
                         <li>
                            <h4 className="text-lg font-bold text-white mb-2">Challenge: Mobile Controls</h4>
                            <p className="text-gray-400">
